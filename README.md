# Due Date Reminder plugin for Redmine [![Build Status](https://secure.travis-ci.org/f0y/due_date_reminder.png?branch=redmine-2.x)](http://travis-ci.org/f0y/due_date_reminder)
